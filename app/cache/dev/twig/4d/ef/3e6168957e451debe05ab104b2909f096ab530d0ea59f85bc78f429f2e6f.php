...
/* projetBundle:ChefDEnquete:show.html.twig */
class __TwigTemplate_4def3e6168957e451debe05ab104b2909f096ab530d0ea59f85bc78f429f2e6f extends Twig_Template
{
    ...
    <li>
        <a href=\"";
        // line 49
        echo $this->env->getExtension('routing')->getPath("chefdenquete");
        echo "\">
            Back to the list
        </a>
    </li>
    <li>
        <a href=\"";
        // line 54
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("chefdenquete_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
...
";
    ...
    {
        return "projetBundle:ChefDEnquete:show.html.twig";
    }
